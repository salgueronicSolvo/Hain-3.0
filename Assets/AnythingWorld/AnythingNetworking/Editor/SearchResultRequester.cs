...
namespace AnythingWorld.Networking
{
    public static class SearchResultRequester
    {
        ...
        public static void RequestCategorySearchResults(string searchTerm, SortingDropdownOption currentSortingMethod, SearchCompleteDelegate searchCompleteDelegate, Action refreshWindow, object owner)
        {
            try
            {
#if UNITY_EDITOR
                EditorCoroutineUtility.StartCoroutine(CategorySearch(searchTerm, currentSortingMethod, searchCompleteDelegate, refreshWindow, owner), owner);
#endif
            }
            catch (Exception e)
            {
        ...
        public static IEnumerator CategorySearch(string searchTerm, SortingDropdownOption currentSortingMethod, SearchCompleteDelegate delegateFunc, Action onThumbnailLoad, object owner)
        {
