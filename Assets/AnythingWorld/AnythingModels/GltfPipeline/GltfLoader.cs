...
namespace AnythingWorld.Models
{
    public static class GltfLoader
    {
        ...
        private static void LoadAnimatedGlb(ModelData data)
        {
            ...
            ModelPostProcessing.Process(data,data.actions.loadAnimationDelegate);
        }
        /// <summary>
        ...
        private static GameObject LoadGlbAndAnimation(ModelData data, string key)
        {
            ...
            setting.animationSettings.compressBlendShapeKeyFrames = false;
            setting.animationSettings.interpolationMode = InterpolationMode.STEP;
