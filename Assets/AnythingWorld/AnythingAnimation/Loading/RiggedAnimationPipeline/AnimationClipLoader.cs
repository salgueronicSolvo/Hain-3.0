...
namespace AnythingWorld.Animation
{
    ...
    public class AnimationClipLoader
    {
        ...
        {
            LoadAnimClipLegacy(data.loadedData.gltf.animationClips, data.rig);
        }
        ...
        public static void LoadAnimClipLegacy(Dictionary<string,AnimationClip> animationClips, GameObject target)
        {
            //Load legacy animations
            var anim = target.AddComponent<Animation>();
            var legacyAnimationController = target.AddComponent<RunWalkIdleController>();
            foreach (var kvp in animationClips)
            {
                ...
                //currently we only have walk animations
        ...
        {
            Debug.Log("Loading default animations");
