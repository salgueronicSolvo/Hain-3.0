    ...
    public class ModelBrowserEditor : AnythingCreatorEditor
    {
        ...
        internal static void Initialize()
        {
            ...
            if (AnythingSettings.Instance.HasAPIKey())
            {
                ...
                //browser.minSize = new Vector2(450, 0);
                browser.Show();

                tabWindow = GetWindow<MyWorldEditor>("My World", false, typeof(ModelBrowserEditor));
            ...
            else
            {
                ...
                //tabWindow.minSize = new Vector2(450, 0);
            }
        }
        ...
        internal static void Initialize(Rect windowPosition)
        {
            ...
            {
                var browser = GetWindow(typeof(ModelBrowserEditor), false, "Anything Browser");
                browser.position = windowPosition;
                browser.minSize = new Vector2(450, 0);
                browser.Show();
            ...
            {
                tabWindow = GetWindow<LogInEditor>("Log In | Sign Up", false, typeof(ModelBrowserEditor));
                tabWindow.position = windowPosition;
                tabWindow.minSize = new Vector2(450, 0);
            }
        }
        ...
        private void OnSearch(string termToSearch)
        {
            ...
            SearchResultRequester.RequestCategorySearchResults(searchTerm, currentSortingMethod, UpdateSearchResults, Repaint, this);
        }
